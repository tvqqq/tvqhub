...
if (!function_exists('tvqhub_setup')) :
    ...
    function tvqhub_setup()
    {
        ...
        add_theme_support('custom-background', apply_filters('tvqhub_custom_background_args', array(
...
{
    // Base css & js
    wp_enqueue_style('tvqhub-css', get_stylesheet_uri());
    wp_enqueue_script('tvqhub-js', get_template_directory_uri() . '/js/script.js');
}
