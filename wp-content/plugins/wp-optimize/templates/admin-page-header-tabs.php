...
<?php
	...
	?>
	<a id="wp-optimize-nav-tab-<?php echo esc_attr($page).'-'.$tab_id; ?>" href="<?php esc_attr_e($options->admin_page_url()); ?>&amp;tab=wp_optimize_<?php echo $tab_id; ?>" class="nav-tab <?php if ($active_tab == $tab_id) echo 'nav-tab-active'; ?>">
		<?php if ($tab_icon) : ?>
